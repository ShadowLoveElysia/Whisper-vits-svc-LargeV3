...
python svc_inferencev3.py --config configs/base.yaml --model melina_ark_v3_sovits5.0_1000.pt.pth --spk ./data_svc/singer/erorigin441k16bit1770_55.spk.npy --wave ying.wav --shift 0
